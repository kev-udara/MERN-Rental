...
import { getAllBookings, cancelBookings,removeBookings } from '../redux/actions/bookingActions'
     ...
     <Row justify='center' gutter={16}>
      <Col lg={17} sm={24}>
        ...
        >
            ...
            onConfirm={()=>{dispatch(removeBookings({bookingid: booking._id, bookedTimeSlots : booking.bookedTimeSlots}))}}
            okText="Yes"
            cancelText="No"
        >
