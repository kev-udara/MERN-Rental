...
function Home(){
    const images = [
        "https://4kwallpapers.com/images/wallpapers/bugatti-la-voiture-noire-worlds-expensive-cars-hypercars-3440x1440-5557.jpg",
        "https://www.hdcarwallpapers.com/download/mso_mclaren_720s_black_4k-3840x2160.jpg",
        "https://wallpapercrafter.com/desktop/12088-toyota-supra-toyota-sportscar-gray-side-view-night-dark-4k.jpg"
    ];
    ...
    return (
       ...
       <Slide {...properties}>
            <div className="home-each-slide-effect">
                ...
                <p className='slide-show-paraone'>FOR YOUR SPECIAL OCCASION</p>
                <p className='slide-show-paratwo'>DRIVE WITH PLEASURE</p>
                <ScrollDown /> 
                </div>
                </div>
            </div>
            ...
            <div className="home-each-slide-effect">
                ...
                <h1 className='welcome-text' style={{marginLeft:'110px',marginTop:'25px'}}>Welcome To EZ-Auto</h1>
                <div style={{marginLeft:'115px'}}>
                <h2 className='welcome-text-title'>LUXURY/EXOTIC CAR <br/>RENTAL SERVICE IN <br/>SRI LANKA</h2>
                </div>
                ...
                <p className='welcome-paragraph'>EZ-Auto is a dynamic and user-friendly car rental website designed to provide customers with an effortless experience in renting a car. The website is easy to navigate, allowing users to search for their preferred vehicle, choose their rental dates, and make a reservation with just a few clicks. EZ-Auto offers a vast selection of cars, from economy to luxury vehicles, and provides customers with competitive pricing options. Most cars in our fleet are from recent years, it means you need not worry about comfort and convenience while you ride with us. The website also offers various add-on features such as GPS, child seats, and additional information, giving customers the flexibility to customize their rental experience to their specific needs. EZ-Auto is committed to providing a secure and reliable rental service, with strict measures in place to ensure the safety of customer data and payment information. Overall, EZ-Auto is an ideal platform for anyone looking for a seamless and convenient car rental experience.</p>
